...
int main() {
    ...
    for (char letter = 'A'; letter <= 'Z'; ++letter) {
        if (frequencyOfRepetitionOfSingleLetters[letter]) {
            cout << letter << " : " << frequencyOfRepetitionOfSingleLetters[letter] << endl;
        }
    }
    ...
    for (char firstLetter = 'A'; firstLetter <= 'Z'; ++firstLetter) {
        for (char secondLetter = 'A'; secondLetter <= 'Z'; ++secondLetter) {
            ...
            if (frequencyOfRepetitionOfDoubleLetters[firstLetter][secondLetter]) {
                cout << firstLetter << secondLetter << " : " << frequencyOfRepetitionOfDoubleLetters[firstLetter][secondLetter] << endl;
            }
        }
    }
